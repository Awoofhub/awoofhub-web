  ...
  return (
    <main className="bg-white">
      ...
      <div className="bg-background my-5">
        <section className="relative text-center py-4 px-6 md:py-8 md:px-12 max-w-[1440px] mx-auto">
          {/* Star decorations */}
          <Image
          ...
          />
          <Image
            className="absolute top-42 right-1/10 hidden md:block"
            alt="star"
            src="/star.png"
            width={25}
            height={25}
          ...
          />
          <Image
            className="absolute bottom-14 right-3/8 hidden md:block"
            alt="star"
            src="/star.png"
            width={25}
            height={25}
          />
          <h2 className="text-primary px-8 py-2 rounded-xl mb-8 font-semibold inline-flex uppercase bg-gray-50 border border-gray-100 shadow-md">
            About Us
          </h2>
      ...
      {/* What makes AwoofHub */}
      <div className="bg-background my-5">
        <section className="py-10 md:py-12 lg:py-16 px-6 md:px-12 max-w-[1440px] mx-auto text-center">
        ...
        <section className="py-10 md:py-12 lg:py-16 px-6 md:px-12 max-w-[1440px] mx-auto">
          <div className="flex flex-col-reverse md:flex-row-reverse items-center gap-4 md:gap-12">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-muted text-base md:text-lg lg:text-xl mt-4 md:text-start text-end font-medium">
      ...
      {/* Meet the Team */}
      <div className="bg-background my-5">
        <section className="py-12 lg:py-16 px-6 md:px-12 max-w-[1440px] mx-auto text-center">
          <div className="flex flex-col items-center gap-1">
            <h2 className="text-3xl font-semibold">Meet the team</h2>
            <Image src="/line.png" alt="line" width={200} height={200} />
          </div>
          <p className="text-muted mt-4 font-medium mb-12 text-base md:text-lg lg:text-xl">
      ...
      <div className="bg-background my-5">
        <section className="py-10 md:py-12 lg:py-16 px-6 md:px-12 max-w-[1440px] mx-auto">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            {/* Stats */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full md:w-1/2 lg:w-2/5">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="border border-gray-50 bg-[#FAFAFA] shadow-sm flex flex-col items-center justify-center text-center p-6 md:aspect-square"
                >
            ...
            {/* Join Community */}
            <div className="w-full lg:ms-30 md:w-1/2 lg:w-3/5">
              <div className="flex flex-col gap-1">
              ...
              <p className="text-muted max-w-xl  font-medium text-base md:text-lg lg:text-xl my-6">
                Thousands of people use AwoofHub to discover deals every day.
                Browse active offers, publish deal and start saving today.
              </p>
              <Link
                href="/offers"
                className="inline-block px-6 py-3 w-full md:w-60 text-base text-center bg-primary text-white font-semibold rounded-md hover:bg-orange-600 transition-colors"
              >
