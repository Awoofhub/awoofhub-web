...
export default function CategoryLinks({ categories, activeId }: Props) {
  ...
  return (
    <div className="max-w-[1440px] mx-auto sticky bg-white top-16 lg:top-20 z-40 mb-10 border-b border-gray-200 py-3 px-6 md:px-12">
        ...
        >
          {categories.map((cat) => (
            <Link
              ...
              href={`#${cat.id}`}
              data-id={cat.id}
              className={`px-5 py-1.5 font-semibold rounded-full text-sm whitespace-nowrap
