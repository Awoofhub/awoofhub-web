  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="bg-white rounded-2xl w-full max-w-[500px] p-6 md:p-10 flex flex-col items-center text-center">
        ...
        <p className="text-gray-500 text-base md:text-lg mb-8">Changes saved successfully.</p>
        <button
          onClick={onClose}
          className="w-full font-baloo text-lg bg-primary text-white py-3 rounded-md font-semibold hover:bg-orange-700 transition-colors"
        >
          Done
        </button>
      </div>
