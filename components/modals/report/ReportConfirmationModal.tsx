...
export default function ReportConfirmationModal({ isOpen, onDone }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={onDone}>
      <div className="bg-white rounded-2xl w-full max-w-[400px] lg:max-w-[500px] p-6  flex flex-col items-center text-center" onClick={(e) => e.stopPropagation()}>
        <Image
          src="/EditSuccess.svg"
          alt="success-img"
          width={150}
