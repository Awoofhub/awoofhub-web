...
import { useCreateImpression } from "@/features/boost/useCreateImpression";
...
export default function BoostedOfferCard({ offer }: Props) {

  const { createImpression, isPending } = useCreateImpression({ id: offer.id })
