    ...
    >
      ...
      <div className="relative mb-2 lg:mb-3 rounded-lg overflow-hidden flex-grow bg-white">
        <div className="absolute top-2 md:top-4 left-2 right-2 flex justify-between items-center z-10">
          ...
          <div
            className="w-7 h-7 lg:w-9 lg:h-9 bg-white rounded-full flex items-center justify-center"
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
            }}
      ...
      <div className="md:px-2">
        ...
        <div className="flex flex-wrap items-center justify-between mb-1 lg:mb-2">
        ...
        <div className="flex flex-col">
          <h4 className="font-bold text-black text-xs md:text-sm lg:text-base mb-1 line-clamp-1">
            {offer.title}
          </h4>
          <p className="text-muted text-[10px] md:text-xs lg:text-sm mb-1 lg:mb-2 line-clamp-2">
            {offer.description}
          </p>
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-1 lg:mb-2">
              <div className="flex items-center gap-1">
                <Rating
                  name="readonly"
                  className="ml-[-3px] !text-[16px] md:!text-[18px] lg:!text-[22px]"
