  ...
  return (
    <div className="grid grid-cols-2 xs:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-3 xl:gap-4 justify-items-center w-full">
      {[...Array(number)].map((_, i) => (
        <div
          key={i}
          className="bg-white w-full h-[270px] xxs:h-[300px] xs:h-[270px] md:h-[350px] lg:h-[380px] xl:h-[440px] rounded-xl shadow-sm border border-gray-100 p-1.5 md:p-2 lg:p-3 flex flex-col"
        >
